...
namespace System.Linq
{
    public static class LinqExtensions
    {
        ...
        public static TR Bind<T1, T2, TR>(this Tuple<T1, T2> tuple, Func<T1, T2, TR> func) { return func(tuple.Item1, tuple.Item2); }
        public static TR Bind<T1, T2, T3, TR>(this Tuple<T1, T2, T3> tuple, Func<T1, T2, T3, TR> func) { return func(tuple.Item1, tuple.Item2, tuple.Item3); }
        public static TR Bind<T1, T2, T3, T4, TR>(this Tuple<T1, T2, T3, T4> tuple, Func<T1, T2, T3, T4, TR> func) { return func(tuple.Item1, tuple.Item2, tuple.Item3, tuple.Item4); }        
